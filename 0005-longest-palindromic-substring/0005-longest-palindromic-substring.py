class Solution:
    def longestPalindrome(self, s: str) -> str:
        ...
        for i in range(len(s)):
            len1 = self.center_expand(s, i, i) # Try expanding around a single character (odd-length palindrome)
            len2 = self.center_expand(s, i, i + 1) # Try expanding around two characters (even-length palindrome)

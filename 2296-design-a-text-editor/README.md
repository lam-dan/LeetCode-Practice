<h2><a href="https://leetcode.com/problems/design-a-text-editor/description/">2296. Design a Text Editor</a></h2><h3>Hard</h3><hr><p>Design a text editor with a cursor that can do the following:</p>
